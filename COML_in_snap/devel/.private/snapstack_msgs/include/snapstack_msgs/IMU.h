...
struct IMU_
{
  ...
  _accel_type accel;
   ...
   typedef double _loop_time_type;
...
struct MD5Sum< ::snapstack_msgs::IMU_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x59179daecd2e147aULL;
  static const uint64_t static_value2 = 0x20604025d5dc1381ULL;
};
...
struct Printer< ::snapstack_msgs::IMU_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::snapstack_msgs::IMU_<ContainerAllocator>& v)
  {
    ...
    s << indent << "loop_time: ";
    Printer<double>::stream(s, indent + "  ", v.loop_time);
  }
};
