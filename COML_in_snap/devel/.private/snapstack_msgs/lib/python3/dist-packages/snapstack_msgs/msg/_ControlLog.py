...
class ControlLog(genpy.Message):
  _md5sum = "f8bf2fc1a737a49fa227aa4e424a7184"
...
float64 w
"""
  __slots__ = ['header','p','p_ref','p_err','p_err_int','v','v_ref','v_err','a_ff','a_fb','j_ff','j_fb','q','q_ref','rpy','rpy_ref','w','w_ref','F_W','P_norm','A_norm','y_norm','f_hat','power']
  _slot_types = ['std_msgs/Header','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Quaternion','geometry_msgs/Quaternion','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','float32','float32','float32','geometry_msgs/Vector3','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,p,p_ref,p_err,p_err_int,v,v_ref,v_err,a_ff,a_fb,j_ff,j_fb,q,q_ref,rpy,rpy_ref,w,w_ref,F_W,P_norm,A_norm,y_norm,f_hat,power
    ...
    if args or kwds:
      ...
      if self.f_hat is None:
        self.f_hat = geometry_msgs.msg.Vector3()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.p.x, _x.p.y, _x.p.z, _x.p_ref.x, _x.p_ref.y, _x.p_ref.z, _x.p_err.x, _x.p_err.y, _x.p_err.z, _x.p_err_int.x, _x.p_err_int.y, _x.p_err_int.z, _x.v.x, _x.v.y, _x.v.z, _x.v_ref.x, _x.v_ref.y, _x.v_ref.z, _x.v_err.x, _x.v_err.y, _x.v_err.z, _x.a_ff.x, _x.a_ff.y, _x.a_ff.z, _x.a_fb.x, _x.a_fb.y, _x.a_fb.z, _x.j_ff.x, _x.j_ff.y, _x.j_ff.z, _x.j_fb.x, _x.j_fb.y, _x.j_fb.z, _x.q.x, _x.q.y, _x.q.z, _x.q.w, _x.q_ref.x, _x.q_ref.y, _x.q_ref.z, _x.q_ref.w, _x.rpy.x, _x.rpy.y, _x.rpy.z, _x.rpy_ref.x, _x.rpy_ref.y, _x.rpy_ref.z, _x.w.x, _x.w.y, _x.w.z, _x.w_ref.x, _x.w_ref.y, _x.w_ref.z, _x.F_W.x, _x.F_W.y, _x.F_W.z, _x.P_norm, _x.A_norm, _x.y_norm, _x.f_hat.x, _x.f_hat.y, _x.f_hat.z, _x.power,) = _get_struct_56d3f3dB().unpack(str[start:end])
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_56d3f3dB = None
def _get_struct_56d3f3dB():
    global _struct_56d3f3dB
    if _struct_56d3f3dB is None:
        _struct_56d3f3dB = struct.Struct("<56d3f3dB")
    return _struct_56d3f3dB
