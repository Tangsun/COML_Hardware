...
class IMU {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float64(obj.loop_time, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.loop_time = _deserializer.float64(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return '59179daecd2e147a20604025d5dc1381';
  }
