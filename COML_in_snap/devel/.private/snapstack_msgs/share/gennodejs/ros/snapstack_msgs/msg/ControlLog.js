...
class ControlLog {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('P_norm')) {
        this.P_norm = initObj.P_norm
      }
      else {
        this.P_norm = 0.0;
      }
      if (initObj.hasOwnProperty('A_norm')) {
        this.A_norm = initObj.A_norm
      }
      else {
        this.A_norm = 0.0;
      }
      if (initObj.hasOwnProperty('y_norm')) {
        this.y_norm = initObj.y_norm
      }
      else {
        this.y_norm = 0.0;
      }
      if (initObj.hasOwnProperty('f_hat')) {
        this.f_hat = initObj.f_hat
      }
      else {
        this.f_hat = new geometry_msgs.msg.Vector3();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [P_norm]
    bufferOffset = _serializer.float32(obj.P_norm, buffer, bufferOffset);
    // Serialize message field [A_norm]
    bufferOffset = _serializer.float32(obj.A_norm, buffer, bufferOffset);
    // Serialize message field [y_norm]
    bufferOffset = _serializer.float32(obj.y_norm, buffer, bufferOffset);
    // Serialize message field [f_hat]
    bufferOffset = geometry_msgs.msg.Vector3.serialize(obj.f_hat, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [P_norm]
    data.P_norm = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [A_norm]
    data.A_norm = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [y_norm]
    data.y_norm = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [f_hat]
    data.f_hat = geometry_msgs.msg.Vector3.deserialize(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.P_norm !== undefined) {
      resolved.P_norm = msg.P_norm;
    }
    else {
      resolved.P_norm = 0.0
    }

    if (msg.A_norm !== undefined) {
      resolved.A_norm = msg.A_norm;
    }
    else {
      resolved.A_norm = 0.0
    }

    if (msg.y_norm !== undefined) {
      resolved.y_norm = msg.y_norm;
    }
    else {
      resolved.y_norm = 0.0
    }

    if (msg.f_hat !== undefined) {
      resolved.f_hat = geometry_msgs.msg.Vector3.Resolve(msg.f_hat)
    }
    else {
      resolved.f_hat = new geometry_msgs.msg.Vector3()
    }
