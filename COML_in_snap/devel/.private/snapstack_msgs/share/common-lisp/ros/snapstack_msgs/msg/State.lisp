...
(cl:defmethod cl:initialize-instance :after ((m <State>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'State)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name snapstack_msgs-msg:<State> is deprecated: use snapstack_msgs-msg:State instead.")))
...
(cl:defmethod state_stamp-val ((m <State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:state_stamp-val is deprecated.  Use snapstack_msgs-msg:state_stamp instead.")
  (state_stamp m))

(cl:ensure-generic-function 'pos-val :lambda-list '(m))
(cl:defmethod pos-val ((m <State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:pos-val is deprecated.  Use snapstack_msgs-msg:pos instead.")
  (pos m))

(cl:ensure-generic-function 'vel-val :lambda-list '(m))
(cl:defmethod vel-val ((m <State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:vel-val is deprecated.  Use snapstack_msgs-msg:vel instead.")
  (vel m))

(cl:ensure-generic-function 'quat-val :lambda-list '(m))
(cl:defmethod quat-val ((m <State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:quat-val is deprecated.  Use snapstack_msgs-msg:quat instead.")
  (quat m))
...
(cl:defmethod abias-val ((m <State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:abias-val is deprecated.  Use snapstack_msgs-msg:abias instead.")
  (abias m))

(cl:ensure-generic-function 'gbias-val :lambda-list '(m))
(cl:defmethod gbias-val ((m <State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:gbias-val is deprecated.  Use snapstack_msgs-msg:gbias instead.")
  (gbias m))
