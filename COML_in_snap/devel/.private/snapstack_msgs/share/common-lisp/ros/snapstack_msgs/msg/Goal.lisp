...
(cl:defmethod psi-val ((m <Goal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:psi-val is deprecated.  Use snapstack_msgs-msg:psi instead.")
  (psi m))

(cl:ensure-generic-function 'dpsi-val :lambda-list '(m))
(cl:defmethod dpsi-val ((m <Goal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:dpsi-val is deprecated.  Use snapstack_msgs-msg:dpsi instead.")
  (dpsi m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Goal>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'dpsi))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Goal>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'j) istream)
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'dpsi) (roslisp-utils:decode-double-float-bits bits)))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Goal>)))
  ...
  "b0f60475b1346f247f102ae07228cff4")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Goal)))
  "Returns md5sum for a message object of type 'Goal"
  "b0f60475b1346f247f102ae07228cff4")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Goal>)))
  ...
  (cl:format cl:nil "# Use this message to command the outer loop to track~%# a trajectory generated from a high-level trajectory planner.~%~%Header header~%~%# Current time-slice of desired trajectory~%geometry_msgs/Point p # position~%geometry_msgs/Vector3 v # velocity~%geometry_msgs/Vector3 a # acceleration~%geometry_msgs/Vector3 j # jerk~%~%float64 psi # angle as defined in Sec. III of https://arxiv.org/pdf/2103.06372.pdf  ~%# In general, it is will not be the rXYZ yaw Euler angle of the UAV (unless the drone is in a hover condition).~%# This is due to the fact that q_psi (see link above) already has some rXYZ yaw on it.~%# See also the paper https://link.springer.com/chapter/10.1007/978-3-030-28619-4_20~%float64 dpsi #d{psi}/dt~%~%bool power # true if motors should be able to spin~%~%# Trajectory tracking mode constants~%uint8 MODE_POSITION_CONTROL     = 0~%uint8 MODE_VELOCITY_CONTROL     = 1~%uint8 MODE_ACCELERATION_CONTROL = 2~%~%# Trajectory tracking mode for x/y and z components.~%# The default is POSITION control, which uses position and velocity error~%# to calculate the control effort. VELOCITY control only uses vel error.~%# ACCELERATION mode does not use tracking error and could be used to provide~%# a control signal computed from something other than the default PID cntrl.~%uint8 mode_xy~%uint8 mode_z~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Goal)))
  "Returns full string definition for message of type 'Goal"
  (cl:format cl:nil "# Use this message to command the outer loop to track~%# a trajectory generated from a high-level trajectory planner.~%~%Header header~%~%# Current time-slice of desired trajectory~%geometry_msgs/Point p # position~%geometry_msgs/Vector3 v # velocity~%geometry_msgs/Vector3 a # acceleration~%geometry_msgs/Vector3 j # jerk~%~%float64 psi # angle as defined in Sec. III of https://arxiv.org/pdf/2103.06372.pdf  ~%# In general, it is will not be the rXYZ yaw Euler angle of the UAV (unless the drone is in a hover condition).~%# This is due to the fact that q_psi (see link above) already has some rXYZ yaw on it.~%# See also the paper https://link.springer.com/chapter/10.1007/978-3-030-28619-4_20~%float64 dpsi #d{psi}/dt~%~%bool power # true if motors should be able to spin~%~%# Trajectory tracking mode constants~%uint8 MODE_POSITION_CONTROL     = 0~%uint8 MODE_VELOCITY_CONTROL     = 1~%uint8 MODE_ACCELERATION_CONTROL = 2~%~%# Trajectory tracking mode for x/y and z components.~%# The default is POSITION control, which uses position and velocity error~%# to calculate the control effort. VELOCITY control only uses vel error.~%# ACCELERATION mode does not use tracking error and could be used to provide~%# a control signal computed from something other than the default PID cntrl.~%uint8 mode_xy~%uint8 mode_z~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
