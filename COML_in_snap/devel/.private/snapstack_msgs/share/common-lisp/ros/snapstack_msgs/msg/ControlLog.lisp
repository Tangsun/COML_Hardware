...
(cl:ensure-generic-function 'P_norm-val :lambda-list '(m))
(cl:defmethod P_norm-val ((m <ControlLog>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:P_norm-val is deprecated.  Use snapstack_msgs-msg:P_norm instead.")
  (P_norm m))

(cl:ensure-generic-function 'A_norm-val :lambda-list '(m))
(cl:defmethod A_norm-val ((m <ControlLog>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:A_norm-val is deprecated.  Use snapstack_msgs-msg:A_norm instead.")
  (A_norm m))

(cl:ensure-generic-function 'y_norm-val :lambda-list '(m))
(cl:defmethod y_norm-val ((m <ControlLog>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:y_norm-val is deprecated.  Use snapstack_msgs-msg:y_norm instead.")
  (y_norm m))

(cl:ensure-generic-function 'f_hat-val :lambda-list '(m))
(cl:defmethod f_hat-val ((m <ControlLog>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:f_hat-val is deprecated.  Use snapstack_msgs-msg:f_hat instead.")
  (f_hat m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ControlLog>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'P_norm))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'A_norm))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'y_norm))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'f_hat) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ControlLog>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'F_W) istream)
    ...
    (cl:setf (cl:slot-value msg 'P_norm) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'A_norm) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'y_norm) (roslisp-utils:decode-single-float-bits bits)))
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'f_hat) istream)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ControlLog>)))
  ...
  "f8bf2fc1a737a49fa227aa4e424a7184")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ControlLog)))
  "Returns md5sum for a message object of type 'ControlLog"
  "f8bf2fc1a737a49fa227aa4e424a7184")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ControlLog>))
  (cl:+ 0
     ...
     4
     4
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'f_hat))
     1
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ControlLog>))
  ...
  (cl:list 'ControlLog
    ...
    (cl:cons ':F_W (F_W msg))
    (cl:cons ':P_norm (P_norm msg))
    (cl:cons ':A_norm (A_norm msg))
    (cl:cons ':y_norm (y_norm msg))
    (cl:cons ':f_hat (f_hat msg))
